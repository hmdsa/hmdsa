...
* *[A ML-based Runtime System for Executing Dataflow Graphs on Heterogeneous Processors.](https://ieeexplore.ieee.org/document/8490591)*. Banerjee, S. S., Athreya, A. P., Kalbarczyk, Z., Lumetta, S., & Iyer, R. K. (2018, October). A ML-based Runtime System for Executing Dataflow Graphs on Heterogeneous Processors. In Proceedings of the ACM Symposium on Cloud Computing (SOCC). ACM.
