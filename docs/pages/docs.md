...
* *[Online Diagnosis of Performance Variation in HPC Systems Using Machine Learning](https://dx.doi.org/10.1109/TPDS.2018.2870403)*. O. Tuncer, E. Ates, Y. Zhang, A. Turk, J. Brandt, V. Leung, M.Egele, and A. Coskun IEEE Transactions on Parallel and Distributed Systems (Sep 2018) doi: 10.1109/TPDS.2018.2870403
* *[Characterizing Supercomputer Traffic Networks Through Link-Level Analysis](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)* S. Jha, J. Brandt, A. Gentile, Z. Kalbarczyk, and R. Iyer Workshop on Monitoring and Analysis of High Performance Computing Systems Plus Applications (HPCMASPA) at IEEE Int'l. Conf. on Cluster Computing (CLUSTER), Sep 2018. 
...
* *[Integrating Low-latency Analysis into HPC System Monitoring](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)*. R. Izadpanah, N. Naksinehaboon, J. Brandt, A. Gentile, and D. Dechev 47th Int'l Conference on Parallel Processing (ICPP), Aug 2018. 
* *[Supporting Failure Analysis with Discoverable, Annotated Log Datasets](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)*. S. Leak, A. Greiner, A. Gentile, and J. Brandt. Cray Users Group (CUG), May 2018. 
...
* *[Runtime Collection and Analysis of System Metrics for Production Monitoring of Trinity Phase II](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)* A. DeConinck, H. Nam, D. Morton, A. Bonnie, C. Lueninghoener (LANL), J. Brandt, A. Gentile, K. Pedretti, A. Agelastos, C. Vaughan, S. Hammond, B. Allan (SNL), M. Davis and J. Repik (Cray) Cray Users Group (CUG), May 2017.
...
* *[Final Report Workload Analysis of Blue Waters](https://bluewaters.ncsa.illinois.edu/liferay-content/document-library/Technical%20Reports/XDMoD-BW-FinalReport.pdf)*. M. D. Jones, J. P. White, M. I., R. L. DeLeon, N. Simakov, J. T. Palmer, S. M. Gallo, and T. R. Furlani (SUNY) and M. Showerman, R. Brunner, A. Kot, G. Bauer, B. Bode, J. Enos, and W. Kramer (NCSA), University of Illinois at Urbana-Champaign, ACI 1650758, Jan 2017.
...
* *[Continuous Whole-System Monitoring Toward Rapid Understanding of Production HPC Applications and Systems](http://dx.doi.org/10.1016/j.parco.2016.05.009)* A. Agelastos, B. Allan, J. Brandt, A. Gentile, S. Lefantzi, S. Monk, J. Ogden, M. Rajan, and J. Stevenson Parallel Computing (2016), Elsevier B. V., http://dx.doi.org/10.1016/j.parco.2016.05.009
* *[Large-Scale Persistent Numerical Data Source Monitoring System Experiences](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)*. J. Brandt, A. Gentile, M. Showerman, J. Enos,
...
* *[Network Performance Counter Monitoring and Analysis on the Cray XC Platform](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)* J. Brandt, E. Froese, A. Gentile, L. Kaplan, B. Allan, and E. Walsh Cray Users Group (CUG), May 2016.
* *[Dynamic Model Specific Register (MSR) Data Collection as a System Service](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)* G. H. Bauer, J. Brandt, A. Gentile, A. Kot, and M. Showerman Cray Users Group (CUG), May 2016.
* *[Design and Implementation of a Scalable HPC Monitoring System for Trinity](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)* A. DeConinck, A. Bonnie, K. Kelly, S. Sanchez, C. Martin, and M. Mason (LANL), J. Brandt, A. Gentile, B. Allan, and A. Agelastos (SNL), M. Davis and M. Berry (Cray)
...
* *[Infrastructure for In Situ System Monitoring and Application Data Analysis](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)* J. Brandt, K. Devine, and A. Gentile In Situ Infrastructures for Enabling Extreme-scale Analysis and Visualization (ISAV 2015) at IEEE/ACM Int'l. Conf. for High Performance Storage, Networking, and Analysis (SC15), Nov 2015.
...
* *[Extending LDMS to Enable Performance Monitoring in Multi-Core Applications](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)* S. Feldman, D. Zhang, D. Dechev, and J. Brandt
Workshop on Monitoring and Analysis for High Performance Computing Systems Plus Applications (HPCMASPA)  at IEEE Int'l. Conf. on Cluster Computing (CLUSTER) Sept 2015.
* *[Toward Rapid Understanding of Production HPC Applications and Systems](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)* A. Agelastos, B. Allan, J. Brandt, A. Gentile, S. Lefantzi, S. Monk, J. Ogden, M. Rajan, and J. Stevenson IEEE Int'l. Conf. on Cluster Computing (CLUSTER), Sept 2015.
...
* *[Enabling Advanced Operational Analysis Through Multi-Subsystem Data Integration on Trinity](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)* J. Brandt, D. DeBonis, A. Gentile, J. Lujan, C. Martin, D. Martinez, S. Olivier, K. Pedretti, N. Taerat, and R. Velarde Cray User's Group (CUG), April 2015.
...
* *[Demonstrating Improved Application Performance Using Dynamic Monitoring and Task Mapping](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)* J. Brandt, K. Devine, A. Gentile, and K. Pedretti1st Workshop on Monitoring and Analysis for High Performance Computing Systems Plus Applications (HPCMASPA) 
at IEEE Int'l. Conf. on Cluster Computing (CLUSTER) Sept 2014.
...
* *[High Fidelity Data Collection and Transport Service Applied to the Cray XE6/XK6](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)*  J. Brandt, T. Tucker, A. Gentile, D. Thompson, V. Kuhns, and J. Repik Cray User's Group (CUG), May 2013.
* *[Taming of the Shrew: Modeling the Normal and Faulty Behaviour of Large-Scale HPC Systems](https://dx.doi.org/10.1109/ipdps.2012.107)*. Ana Gainaru, Franck Cappello, and William Kramer. IEEE, 2012 IEEE 26th International Parallel and Distributed Processing Symposium, pp 1168- 11792012, doi:10.1109/ipdps.2012.107
...
* *Filtering Log Data: Finding Needles in the Haystack* L. Yu, Z. Zheng, Z. Lan, T. Jones, J. Brandt, and A. Gentile
42nd Annual IEEE/IFIP Int'l. Conf. on Dependable Systems and Networks (DSN). June 2012.
* *Adaptive Event Prediction Strategy with Dynamic Time Window for Large-Scale HPC Systems*. Ana Gainaru, Franck Cappello, Joshi Fullop, Stefan Trausan-Matu, and William Kramer. ACM Press, Managing Large-scale Systems via the Analysis of
...
* *[Modeling and Tolerating Heterogeneous Failures in Large Parallel Systems](https://dx.doi.org/10.1145/2038633.2038637)*. E. Heien, D. Kondo, A. Gainaru, D. LaPine, W. Kramer, and F. Cappello. ACM Press, Proceedings of 2011 International Conference for High Performance Computing, Networking, Storage and Analysis (SC '11), pp 45:1-45:11, Seattle, Washington, U.S.A., 2011,
doi:10.1145/2063384.2063444
* *[Framework for Enabling System Understanding](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)* J. Brandt, F. Chen, A. Gentile, C. Leangsuksun, J. Mayo, P. Pebay, D. Roe, N. Taerat, D. Thompson, and M. Wong 4th Workshop on Resiliency (Resilience) in High Performance Computing
at Euro-Par 2011, Aug 2011.
...
* *[Methodologies for Advance Warning of Compute Cluster Problems via Statistical Analysis: A Case Study](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)* J. Brandt, A. Gentile, J. Mayo, P. Pébay, D. Roe, D. Thompson, and M. Wong Workshop on Resiliency in High Performance Computing (Resilience) at the 18th ACM Int'l. Symposium on High Performance Distributed Computing (HPDC) June 2009.
* *[Resource Monitoring and Management with OVIS to Enable HPC in Cloud Computing](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)* J. Brandt, A. Gentile, J. Mayo, P. Pébay, D. Roe, D. Thompson, and M. Wong 5th Workshop on System Management Techniques, Processes, and Services (SMTPS) - Special Focus on Cloud Computing at the 23rd IEEE Int'l. Parallel and Distributed Processing Symposium (IPDPS) May 2009. 
* *[Using Probabilistic Characterization to Reduce Runtime Faults on HPC Systems](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)*. J. Brandt, B. Debusschere, A. Gentile, J. Mayo, P. Pébay , D. Thompson, and M. Wong Workshop on Resiliency in High-Performance Computing (Resilience)  at the 8th IEEE Symposium on Cluster Computing and the Grid (CCGRID) May 2008.
* *[OVIS: A Tool for Intelligent, Real-time Monitoring of Computational Clusters](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)*. J. M. Brandt, A. C. Gentile, D. J. Hale, and P. P. PébayThe 2nd Workshop on System Monitoring Tools for Large-Scale Parallel Systems (SMTPS) at the 20th IEEE Int'l. Parallel and Distributed Processing Symposium (IPDPS) Apr 2006.
* *[Meaningful Automated Statistical Analysis of Large Computational Clusters](https://ovis.ca.sandia.gov/index.php/Publications_and_presentations)* J. M. Brandt, A. C. Gentile, Y. M. Marzouk, and P. P. Pébay at IEEE Int'l. Conf. on Cluster Computing (CLUSTER) Sep 2005.
...
* *[BlueWaters Torus View (Live)](https://bluewaters.ncsa.illinois.edu/torus-viewer)*
